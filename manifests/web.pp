...
class zabbix::web (
  ...
  $web_config_owner                                                   = $zabbix::web_config_owner,
  $web_config_group                                                   = $zabbix::web_config_group,
  ...
  Variant[Array[Stdlib::Port], Stdlib::Port] $apache_listenport       = $zabbix::apache_listenport,
  Variant[Array[Stdlib::Port], Stdlib::Port] $apache_listenport_ssl   = $zabbix::apache_listenport_ssl,
  $zabbix_api_user                                                    = $zabbix::server_api_user,
  $zabbix_api_pass                                                    = $zabbix::server_api_pass,
  Optional[Array[Stdlib::Host,1]] $zabbix_api_access                  = $zabbix::server_api_access,
  ...
  Boolean $database_double_ieee754                                    = $zabbix::server_database_double_ieee754,
  ...
  $database_port                                                      = $zabbix::server_database_port,
  $zabbix_server                                                      = $zabbix::zabbix_server,
  Optional[String] $zabbix_server_name                                = $zabbix::zabbix_server,
  $zabbix_listenport                                                  = $zabbix::server_listenport,
  ...
  $apache_php_max_input_vars                                          = $zabbix::apache_php_max_input_vars,
  Optional[Stdlib::Absolutepath] $ldap_cacert                         = $zabbix::ldap_cacert,
  Optional[Stdlib::Absolutepath] $ldap_clientcert                     = $zabbix::ldap_clientcert,
  Optional[Stdlib::Absolutepath] $ldap_clientkey                      = $zabbix::ldap_clientkey,
  Optional[Enum['never','allow','try','demand','hard']] $ldap_reqcert = $zabbix::ldap_reqcert,
  Optional[Stdlib::Absolutepath] $saml_sp_key                         = $zabbix::saml_sp_key,
  Optional[Stdlib::Absolutepath] $saml_sp_cert                        = $zabbix::saml_sp_cert,
  Optional[Stdlib::Absolutepath] $saml_idp_cert                       = $zabbix::saml_idp_cert,
  Hash[String[1], Variant[ScalarData, Hash]] $saml_settings           = $zabbix::saml_settings,
  $puppetgem                                                          = $zabbix::puppetgem,
