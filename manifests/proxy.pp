...
class zabbix::proxy (
  Zabbix::Databases $database_type                                            = $zabbix::database_type,
  $database_path                                                              = $zabbix::database_path,
  $zabbix_version                                                             = $zabbix::zabbix_version,
  $zabbix_package_state                                                       = $zabbix::zabbix_package_state,
  Boolean $manage_database                                                    = $zabbix::manage_database,
  Boolean $manage_firewall                                                    = $zabbix::manage_firewall,
  Boolean $manage_repo                                                        = $zabbix::manage_repo,
  Boolean $manage_resources                                                   = $zabbix::manage_resources,
  Boolean $manage_service                                                     = $zabbix::manage_service,
  $zabbix_proxy                                                               = $zabbix::zabbix_proxy,
  $zabbix_proxy_ip                                                            = $zabbix::zabbix_proxy_ip,
  $use_ip                                                                     = $zabbix::proxy_use_ip,
  $zbx_templates                                                              = $zabbix::proxy_zbx_templates,
  $proxy_configfile_path                                                      = $zabbix::proxy_configfile_path,
  $proxy_service_name                                                         = $zabbix::proxy_service_name,
  $mode                                                                       = $zabbix::proxy_mode,
  $zabbix_server_host                                                         = $zabbix::proxy_zabbix_server_host,
  $zabbix_server_port                                                         = $zabbix::proxy_zabbix_server_port,
  $hostname                                                                   = $zabbix::proxy_hostname,
  $listenport                                                                 = $zabbix::proxy_listenport,
  $sourceip                                                                   = $zabbix::proxy_sourceip,
  Integer[0] $enableremotecommands                                            = $zabbix::proxy_enableremotecommands,
  Integer[0] $logremotecommands                                               = $zabbix::proxy_logremotecommands,
  Enum['console', 'file', 'system'] $logtype                                  = $zabbix::proxy_logtype,
  Optional[Stdlib::Absolutepath] $logfile                                     = $zabbix::proxy_logfile,
  $logfilesize                                                                = $zabbix::proxy_logfilesize,
  $debuglevel                                                                 = $zabbix::proxy_debuglevel,
  $pidfile                                                                    = $zabbix::proxy_pidfile,
  $database_schema_path                                                       = $zabbix::database_schema_path,
  $database_host                                                              = $zabbix::proxy_database_host,
  $database_name                                                              = $zabbix::proxy_database_name,
  $database_schema                                                            = $zabbix::proxy_database_schema,
  $database_user                                                              = $zabbix::proxy_database_user,
  $database_password                                                          = $zabbix::proxy_database_password,
  $database_socket                                                            = $zabbix::proxy_database_socket,
  $database_port                                                              = $zabbix::proxy_database_port,
  $database_charset                                                           = $zabbix::server_database_charset,
  $database_collate                                                           = $zabbix::server_database_collate,
  Optional[Enum['required', 'verify_ca', 'verify_full']] $database_tlsconnect = $zabbix::proxy_database_tlsconnect,
  Optional[Stdlib::Absolutepath] $database_tlscafile                          = $zabbix::proxy_database_tlscafile,
  Optional[Stdlib::Absolutepath] $database_tlscertfile                        = $zabbix::proxy_database_tlscertfile,
  Optional[Stdlib::Absolutepath] $database_tlskeyfile                         = $zabbix::proxy_database_tlskeyfile,
  Optional[String[1]] $database_tlscipher                                     = $zabbix::proxy_database_tlscipher,
  Optional[String[1]] $database_tlscipher13                                   = $zabbix::proxy_database_tlscipher13,
  $localbuffer                                                                = $zabbix::proxy_localbuffer,
  $offlinebuffer                                                              = $zabbix::proxy_offlinebuffer,
  $heartbeatfrequency                                                         = $zabbix::proxy_heartbeatfrequency,
  $configfrequency                                                            = $zabbix::proxy_configfrequency,
  $datasenderfrequency                                                        = $zabbix::proxy_datasenderfrequency,
  $startpollers                                                               = $zabbix::proxy_startpollers,
  $startipmipollers                                                           = $zabbix::proxy_startipmipollers,
  $startpollersunreachable                                                    = $zabbix::proxy_startpollersunreachable,
  Integer[1, 1000] $startpreprocessors                                        = $zabbix::proxy_startpreprocessors,
  $starttrappers                                                              = $zabbix::proxy_starttrappers,
  $startpingers                                                               = $zabbix::proxy_startpingers,
  $startdiscoverers                                                           = $zabbix::proxy_startdiscoverers,
  $starthttppollers                                                           = $zabbix::proxy_starthttppollers,
  $javagateway                                                                = $zabbix::proxy_javagateway,
  $javagatewayport                                                            = $zabbix::proxy_javagatewayport,
  $startjavapollers                                                           = $zabbix::proxy_startjavapollers,
  $startvmwarecollectors                                                      = $zabbix::proxy_startvmwarecollectors,
  Optional[String[1]] $vaultdbpath                                            = $zabbix::proxy_vaultdbpath,
  Optional[String[1]] $vaulttoken                                             = $zabbix::proxy_vaulttoken,
  Stdlib::HTTPSUrl $vaulturl                                                  = $zabbix::proxy_vaulturl,
  $vmwarefrequency                                                            = $zabbix::proxy_vmwarefrequency,
  $vmwareperffrequency                                                        = $zabbix::proxy_vmwareperffrequency,
  $vmwarecachesize                                                            = $zabbix::proxy_vmwarecachesize,
  $vmwaretimeout                                                              = $zabbix::proxy_vmwaretimeout,
  $snmptrapperfile                                                            = $zabbix::proxy_snmptrapperfile,
  $snmptrapper                                                                = $zabbix::proxy_snmptrapper,
  $listenip                                                                   = $zabbix::proxy_listenip,
  $housekeepingfrequency                                                      = $zabbix::proxy_housekeepingfrequency,
  $cachesize                                                                  = $zabbix::proxy_cachesize,
  $startdbsyncers                                                             = $zabbix::proxy_startdbsyncers,
  $historycachesize                                                           = $zabbix::proxy_historycachesize,
  $historyindexcachesize                                                      = $zabbix::proxy_historyindexcachesize,
  $historytextcachesize                                                       = $zabbix::proxy_historytextcachesize,
  $timeout                                                                    = $zabbix::proxy_timeout,
  $tlsaccept                                                                  = $zabbix::proxy_tlsaccept,
  $tlscafile                                                                  = $zabbix::proxy_tlscafile,
  $tlscertfile                                                                = $zabbix::proxy_tlscertfile,
  $tlsconnect                                                                 = $zabbix::proxy_tlsconnect,
  $tlscrlfile                                                                 = $zabbix::proxy_tlscrlfile,
  $tlskeyfile                                                                 = $zabbix::proxy_tlskeyfile,
  $tlspskfile                                                                 = $zabbix::proxy_tlspskfile,
  $tlspskidentity                                                             = $zabbix::proxy_tlspskidentity,
  Optional[String[1]] $tlscipherall                                           = $zabbix::proxy_tlscipherall,
  Optional[String[1]] $tlscipherall13                                         = $zabbix::proxy_tlscipherall13,
  Optional[String[1]] $tlsciphercert                                          = $zabbix::proxy_tlsciphercert,
  Optional[String[1]] $tlsciphercert13                                        = $zabbix::proxy_tlsciphercert13,
  Optional[String[1]] $tlscipherpsk                                           = $zabbix::proxy_tlscipherpsk,
  Optional[String[1]] $tlscipherpsk13                                         = $zabbix::proxy_tlscipherpsk13,
  $tlsservercertissuer                                                        = $zabbix::proxy_tlsservercertissuer,
  $tlsservercertsubject                                                       = $zabbix::proxy_tlsservercertsubject,
  $trappertimeout                                                             = $zabbix::proxy_trappertimeout,
  $unreachableperiod                                                          = $zabbix::proxy_unreachableperiod,
  $unavaliabledelay                                                           = $zabbix::proxy_unavaliabledelay,
  $unreachabedelay                                                            = $zabbix::proxy_unreachabedelay,
  $externalscripts                                                            = $zabbix::proxy_externalscripts,
  $fpinglocation                                                              = $zabbix::proxy_fpinglocation,
  $fping6location                                                             = $zabbix::proxy_fping6location,
  $sshkeylocation                                                             = $zabbix::proxy_sshkeylocation,
  $logslowqueries                                                             = $zabbix::proxy_logslowqueries,
  $tmpdir                                                                     = $zabbix::proxy_tmpdir,
  $allowroot                                                                  = $zabbix::proxy_allowroot,
  $include_dir                                                                = $zabbix::proxy_include,
  Optional[Stdlib::Absolutepath] $sslcalocation_dir                           = $zabbix::proxy_sslcalocation,
  Optional[Stdlib::Absolutepath] $sslcertlocation_dir                         = $zabbix::proxy_sslcertlocation,
  Optional[Stdlib::Absolutepath] $sslkeylocation_dir                          = $zabbix::proxy_sslkeylocation,
  $loadmodulepath                                                             = $zabbix::proxy_loadmodulepath,
  $loadmodule                                                                 = $zabbix::proxy_loadmodule,
  Boolean $manage_selinux                                                     = $zabbix::manage_selinux,
  Optional[Stdlib::Absolutepath] $socketdir                                   = $zabbix::proxy_socketdir,
