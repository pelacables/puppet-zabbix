...
class zabbix::server (
  ...
  $server_configfile_path                                                     = $zabbix::server_configfile_path,
  $server_config_owner                                                        = $zabbix::server_config_owner,
  $server_config_group                                                        = $zabbix::server_config_group,
  $server_service_name                                                        = $zabbix::server_service_name,
  $pacemaker                                                                  = $zabbix::server_pacemaker,
  $pacemaker_resource                                                         = $zabbix::server_pacemaker_resource,
  $listenport                                                                 = $zabbix::server_listenport,
  $sourceip                                                                   = $zabbix::server_sourceip,
  Enum['console', 'file', 'system'] $logtype                                  = $zabbix::server_logtype,
  Optional[Stdlib::Absolutepath] $logfile                                     = $zabbix::server_logfile,
  $logfilesize                                                                = $zabbix::server_logfilesize,
  $debuglevel                                                                 = $zabbix::server_debuglevel,
  $pidfile                                                                    = $zabbix::server_pidfile,
  $database_schema_path                                                       = $zabbix::database_schema_path,
  $database_host                                                              = $zabbix::server_database_host,
  $database_name                                                              = $zabbix::server_database_name,
  $database_schema                                                            = $zabbix::server_database_schema,
  $database_user                                                              = $zabbix::server_database_user,
  $database_password                                                          = $zabbix::server_database_password,
  $database_socket                                                            = $zabbix::server_database_socket,
  Optional[Stdlib::Port::Unprivileged] $database_port                         = $zabbix::server_database_port,
  Optional[Enum['required', 'verify_ca', 'verify_full']] $database_tlsconnect = $zabbix::server_database_tlsconnect,
  Optional[Stdlib::Absolutepath] $database_tlscafile                          = $zabbix::server_database_tlscafile,
  Optional[Stdlib::Absolutepath] $database_tlscertfile                        = $zabbix::server_database_tlscertfile,
  Optional[Stdlib::Absolutepath] $database_tlskeyfile                         = $zabbix::server_database_tlskeyfile,
  Optional[String[1]] $database_tlscipher                                     = $zabbix::server_database_tlscipher,
  Optional[String[1]] $database_tlscipher13                                   = $zabbix::server_database_tlscipher13,
  $startpollers                                                               = $zabbix::server_startpollers,
  $startipmipollers                                                           = $zabbix::server_startipmipollers,
  $startpollersunreachable                                                    = $zabbix::server_startpollersunreachable,
  Integer[1, 1000] $startpreprocessors                                        = $zabbix::server_startpreprocessors,
  $starttrappers                                                              = $zabbix::server_starttrappers,
  $startpingers                                                               = $zabbix::server_startpingers,
  Integer[1, 100] $startalerters                                              = $zabbix::server_startalerters,
  $startdiscoverers                                                           = $zabbix::server_startdiscoverers,
  Integer[1, 100] $startescalators                                            = $zabbix::server_startescalators,
  $starthttppollers                                                           = $zabbix::server_starthttppollers,
  $starttimers                                                                = $zabbix::server_starttimers,
  $javagateway                                                                = $zabbix::server_javagateway,
  $javagatewayport                                                            = $zabbix::server_javagatewayport,
  $startjavapollers                                                           = $zabbix::server_startjavapollers,
  Integer[1, 100] $startlldprocessors                                         = $zabbix::server_startlldprocessors,
  Optional[Integer[1, 100]] $startreportwriters                               = undef,
  $startvmwarecollectors                                                      = $zabbix::server_startvmwarecollectors,
  Optional[String[1]] $vaultdbpath                                            = $zabbix::server_vaultdbpath,
  Optional[String[1]] $vaulttoken                                             = $zabbix::server_vaulttoken,
  Stdlib::HTTPSUrl $vaulturl                                                  = $zabbix::server_vaulturl,
  $vmwarefrequency                                                            = $zabbix::server_vmwarefrequency,
  $vmwarecachesize                                                            = $zabbix::server_vmwarecachesize,
  $vmwaretimeout                                                              = $zabbix::server_vmwaretimeout,
  $snmptrapperfile                                                            = $zabbix::server_snmptrapperfile,
  $startsnmptrapper                                                           = $zabbix::server_startsnmptrapper,
  $listenip                                                                   = $zabbix::server_listenip,
  $housekeepingfrequency                                                      = $zabbix::server_housekeepingfrequency,
  $maxhousekeeperdelete                                                       = $zabbix::server_maxhousekeeperdelete,
  $cachesize                                                                  = $zabbix::server_cachesize,
  $cacheupdatefrequency                                                       = $zabbix::server_cacheupdatefrequency,
  $startdbsyncers                                                             = $zabbix::server_startdbsyncers,
  $historycachesize                                                           = $zabbix::server_historycachesize,
  $historyindexcachesize                                                      = $zabbix::server_historyindexcachesize,
  $trendcachesize                                                             = $zabbix::server_trendcachesize,
  $valuecachesize                                                             = $zabbix::server_valuecachesize,
  $timeout                                                                    = $zabbix::server_timeout,
  $tlscafile                                                                  = $zabbix::server_tlscafile,
  $tlscertfile                                                                = $zabbix::server_tlscertfile,
  $tlscrlfile                                                                 = $zabbix::server_tlscrlfile,
  $tlskeyfile                                                                 = $zabbix::server_tlskeyfile,
  Optional[String[1]] $tlscipherall                                           = $zabbix::server_tlscipherall,
  Optional[String[1]] $tlscipherall13                                         = $zabbix::server_tlscipherall13,
  Optional[String[1]] $tlsciphercert                                          = $zabbix::server_tlsciphercert,
  Optional[String[1]] $tlsciphercert13                                        = $zabbix::server_tlsciphercert13,
  Optional[String[1]] $tlscipherpsk                                           = $zabbix::server_tlscipherpsk,
  Optional[String[1]] $tlscipherpsk13                                         = $zabbix::server_tlscipherpsk13,
  $trappertimeout                                                             = $zabbix::server_trappertimeout,
  $unreachableperiod                                                          = $zabbix::server_unreachableperiod,
  $unavailabledelay                                                           = $zabbix::server_unavailabledelay,
  $unreachabledelay                                                           = $zabbix::server_unreachabledelay,
  $alertscriptspath                                                           = $zabbix::server_alertscriptspath,
  $externalscripts                                                            = $zabbix::server_externalscripts,
  $fpinglocation                                                              = $zabbix::server_fpinglocation,
  $fping6location                                                             = $zabbix::server_fping6location,
  $sshkeylocation                                                             = $zabbix::server_sshkeylocation,
  $logslowqueries                                                             = $zabbix::server_logslowqueries,
  $tmpdir                                                                     = $zabbix::server_tmpdir,
  $startproxypollers                                                          = $zabbix::server_startproxypollers,
  $proxyconfigfrequency                                                       = $zabbix::server_proxyconfigfrequency,
  $proxydatafrequency                                                         = $zabbix::server_proxydatafrequency,
  $allowroot                                                                  = $zabbix::server_allowroot,
  $include_dir                                                                = $zabbix::server_include,
  $loadmodulepath                                                             = $zabbix::server_loadmodulepath,
  $loadmodule                                                                 = $zabbix::server_loadmodule,
  $sslcertlocation_dir                                                        = $zabbix::server_sslcertlocation,
  $sslkeylocation_dir                                                         = $zabbix::server_sslkeylocation,
  Boolean $manage_selinux                                                     = $zabbix::manage_selinux,
  String $additional_service_params                                           = $zabbix::additional_service_params,
  Optional[String[1]] $zabbix_user                                            = $zabbix::server_zabbix_user,
  Boolean $manage_startup_script                                              = $zabbix::manage_startup_script,
  Optional[Stdlib::Absolutepath] $socketdir                                   = $zabbix::server_socketdir,
